namespace NGUInjector
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.LoopMinor = new System.Windows.Forms.CheckBox();
			...
			// tabPage8
			// 
			this.tabPage8.Controls.Add(this.LoopMinor);
			...
			// LoopMinor
			// 
			resources.ApplyResources(this.LoopMinor, "LoopMinor");
			this.LoopMinor.Name = "LoopMinor";
			this.LoopMinor.UseVisualStyleBackColor = true;
			this.LoopMinor.CheckedChanged += new System.EventHandler(this.LoopMinor_CheckedChanged);
			// 
			// SettingsForm
			// 
		...
		private System.Windows.Forms.CheckBox LoopMinor;
	}
}